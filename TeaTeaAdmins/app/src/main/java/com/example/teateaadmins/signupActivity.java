...
public class signupActivity extends AppCompatActivity {
    ...
    public DatabaseReference dbread = FirebaseDatabase.getInstance().getReference().child("Admins");
                ...
                dbread.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        if (val == 0) {
                            ...
                            si.user = userGet;
                            si.pass = passGet;
                            data_b.registerAdmin(si.fullname,si.address,si.email,si.contact,si.user,si.pass);
                            Toast.makeText(signupActivity.this,"Signed Up Successfully as Admin!",Toast.LENGTH_SHORT).show();
                            Intent intent_ver = new Intent(signupActivity.this,loginActivity.class);
