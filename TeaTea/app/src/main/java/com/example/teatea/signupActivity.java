...
public class signupActivity extends AppCompatActivity {
    ...
    public DatabaseReference dbread = FirebaseDatabase.getInstance().getReference().child("Customers");
...
//        TeaTeaFirebase db = new TeaTeaFirebase();
        ...
        Button register_btn = findViewById(R.id.btnRegister2);
        ...
        register_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (address.length() == 0) {
                    ...
                    warningAdd.setText("This Address has INVALID FORMAT.");
                    val=1;
                } else {
                    warningAdd.setText("");
                }
                ...
                if (contact.length() == 0) {
                    ...
                    warningContact.setText("The Contact is in INVALID FORMAT.");
                    val=1;
                } else {
