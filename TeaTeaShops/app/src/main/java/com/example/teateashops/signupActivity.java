...
public class signupActivity extends AppCompatActivity {
    ...
    public DatabaseReference dbread = FirebaseDatabase.getInstance().getReference().child("Staffs");
                ...
                dbread.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        if (val == 0) {
                            ...
                            si.user = userGet;
                            si.pass = passGet;
                            // data_b.registerVendors(si.fullname, si.address, si.email, si.contact, si.user, si.pass);
                            Intent intent_ver = new Intent(signupActivity.this, signShopActivity.class);
