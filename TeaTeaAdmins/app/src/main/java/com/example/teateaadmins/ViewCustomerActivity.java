...
public class ViewCustomerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String custId = viewCustAct.getStringExtra("customerid");

        TextView viewName = findViewById(R.id.viewName_viewCustomer);
        TextView viewAdd = findViewById(R.id.viewAdd_viewCustomer);
        TextView viewContact = findViewById(R.id.viewContact_viewCustomer);
        TextView viewEmail = findViewById(R.id.viewEmail_viewCustomer);

        db = FirebaseDatabase.getInstance().getReference().child("Customers").child(custId);
